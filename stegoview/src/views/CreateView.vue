        ...
        <div class="d-flex flex-column justify-content-center align-items-center">
            ...
            <form @submit.prevent="createChannel()" class="form">
                ...
                <div class="mb-3">
                    ...
                    <input @change="onFileInput" type="file" class="form-control" id="inputGroupFile01" accept="image/*" />
                </div>
        ...
        <div :class="`${(showPopUp) ? 'd-flex' : 'd-none'} position-absolute min-vh-100 w-100 justify-content-center align-items-center flex-col`" style="z-index: 999; background: rgba(0,0,0,0.3);">
            <div class="card p-3">
                <div class="card-body text-center">
                    <img v-if="form.feedBack.response.stegoImage !== null" :src="form.feedBack.response.stegoImage" class="rounded-3" alt="stegochat logo" style="max-width: 380px;" />
                    <p class="mt-2 text-muted">Save image for access the channel!</p>
                    <div class="d-flex justify-content-center gap-1 mt-4">
                        <button @click="modalPopUp(false)" class="btn btn-light-danger">
                            Close
                        </button>
                        <a
